public class Human implements Run, Jump {
	...
	public Human(String name, int heightJump, int lenghtRun){
		this.name = name;
	...
	public void running(){ System.out.println(name + " смог пробежать");}
	public void notRunning(){ System.out.println(name + " не смог пробежать");}

	public void jumping() {	System.out.println(name + " смог перепрыгнуть"); }
